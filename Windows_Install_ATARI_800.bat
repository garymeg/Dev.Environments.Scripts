...
set "VASM_DIR=%TOOLS_DIR%\VASM"
set "ATARI_DIR=%TOOLS_DIR%\Atari"
...
echo ========================================
:: Check for Visual Studio Code or Install
...
echo ========================================
    ...
    set "VASM_URL=http://sun.hasenbraten.de/vasm/bin/rel/vasm6502_oldstyle_Win64.zip"
    set "VASM_ZIP=%TEMP_DIR%\VASM.zip"

    curl -L -o "%VASM_ZIP%" "%VASM_URL%"
    tar -xf "%VASM_ZIP%" -C "%VASM_DIR%"
...
echo ========================================
    ...
    set "ATARI_ZIP=%TEMP_DIR%\ATARI.zip"

    curl -L -o "%ATARI_ZIP%" "%ATARI_URL%"
    tar -xf "%ATARI_ZIP%" -C "%ATARI_DIR%"
...
echo ========================================
echo Copying Atari Roms for Retro Debugger
echo ========================================
mkdir "%RETRODEBUG_DIR%\Roms" 2>nul
copy "RetroDebuggerROMS\ROMS\*" "%RETRODEBUG_DIR%\Roms" /Y
